#include "pch.h"
#include "HelloDXMain.h"
#include "Common\DirectXHelper.h"

using namespace HelloDX;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// アプリケーションの読み込み時にアプリケーション資産を読み込んで初期化します。
HelloDXMain::HelloDXMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void HelloDXMain::CreateWindowSizeDependentResources() 
{
...
void HelloDXMain::OnDeviceRestored()
{
